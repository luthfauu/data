# SQL Data Preparation and Customer Insights Project
...
The dataset contains 5,000+ records of customer demographics, transaction behavior, satisfaction scores, complaints, and order history from an e-commerce platform.
...
- A significant share of churned customers had previously raised complaints, highlighting support quality as a retention factor.  
...
- Improve complaint resolution speed and support follow-up.  
...
SQL, data cleaning, feature creation, exploratory analysis

---

## Files Included

- `customer_churn_analysis_queries.sql`  
